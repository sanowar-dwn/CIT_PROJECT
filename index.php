                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6">
                        <div class="banner-content">
                            <h6 class="wow fadeInUp" data-wow-delay="0.2s"><?= $after_assoc_banner['intro']; ?></h6>
                            <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am <?= $after_assoc_banner['name'] ?></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.6s"><?= $after_assoc_banner['descrip'] ?></p>
                            <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                <ul>
                                    <li><a href="<?= $after_assoc_banner['link1'] ?>"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="<?= $after_assoc_banner['link2'] ?>"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="<?= $after_assoc_banner['link3'] ?>"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="<?= $after_assoc_banner['link4'] ?>"><i class="fab fa-pinterest"></i></a></li>
                                </ul>
                            </div>
                            <a href="#" class="btn wow fadeInUp" data-wow-delay="1s"><?= $after_assoc_banner['button'] ?> </a>
                        </div>
                    </div>
