                ...
                <form action="edit_user_post.php" method="POST">
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input name="name" id="first_name" type="text" value="<?= $after_assoc['name'] ?>">
                            <label for="first_name">Full Name</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="password" type="password" name="password" value="<?= $after_assoc['password'] ?>">
                            <label for="password">Password</label>
                        </div>
                        <div class="input-field col s6">
                            <input id="email" type="email" name="email" value="<?= $after_assoc['email'] ?>">
